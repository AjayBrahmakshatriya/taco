#ifndef TACO_STORAGE_OFFSET_H
#define TACO_STORAGE_OFFSET_H
...
class OffsetIterator : public IteratorImpl {
public:
  OffsetIterator(std::string name, const ir::Expr& tensor, int level,
                 Iterator previous);
