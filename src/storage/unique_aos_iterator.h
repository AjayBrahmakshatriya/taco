#ifndef TACO_STORAGE_UNIQUE_AOS_H
#define TACO_STORAGE_UNIQUE_AOS_H
...
class UniqueAosIterator : public IteratorImpl {
public:
  UniqueAosIterator(std::string name, const ir::Expr& tensor, int level,
                 Iterator previous);
  virtual ~UniqueAosIterator() {};
